...
const Login = () => {
    ...
    const { showLogin, setShowLogin, backendUrl, setToken, setUser ,navigate} = useContext(Appcontext);
            ...
            <motion.form onSubmit={onSubmitHandler}
                ...
                {state !== 'Login' &&
                    ...
                    <div className='border px-6 py-2 flex item-center gap-2 rounded-full mt-5'>
                        <img src={assets.profile_icon} width={25} alt="" srcset="" />
                ...
                <button className='bg-blue-600 w-full text-white py-2 rounded-full'>{state === 'Login' ? 'Login' : 'Create acount'}</button>
                ...
                <img src={assets.cross_icon} onClick={() => setShowLogin(false)} alt="" className='absolute top-5 right-5 cursor-pointer' srcset="" />
            </motion.form>
